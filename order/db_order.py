...
from stripe_tasks.stripe_functions import pay
import json
...
class DatabaseOrder(Database):
    ...
    def get_transactions(self):
        ...
        try:
            ...
            for trans in transaction:
                json_transactions.append({"id":trans[0],"stripe_account_id":trans[1],"status":trans[2], "date_created":trans[3], "vendor_id":trans[4], "amount":trans[5]})
    ...
    def register_transactions_of_order(self,orders,payment_method):
        ...
        for key in transactions.keys():
            ...
            query_create_transaction = f"INSERT INTO transactions(account_stripe,status,vendor_id,amount) VALUES('{str(stripe_account[0])}',0,{str(key)},{transactions[key]})"
